...
function menu_switch(menu_status, Name, Tips) {
    if (menu_status == 'true'){
        ...
        GM_notification({text: `已关闭 [${Tips}] 功能`, timeout: 3500, onclick: function(){location.reload();}});
    }else{
        GM_setValue(`${Name}`, true);
        GM_notification({text: `已开启 [${Tips}] 功能`, timeout: 3500, onclick: function(){location.reload();}});
    }
